      ...
      "Our goal is to provide our students with a "
       ...
       "learning experience."
        ...
        for (int i = 0; i < wordstart.Length; i++)
        {
            ...
            //Part 2
            // Create an infinite loop (Uncomment line "--" for infinite loop.
...
boo.Append("B");
//Create a loop where the comparison that's used to determine whether to continue iterating
...
ahh.Append("A");
//Add a loop where the comparison that's used to determine whether to continue iterating the
loop is a "<=" operator.
while (ahh.Length <= 10)
{
    ahh.Append("h");
...
"76ers", "Nets", "Magic", "Wizards", "Hornets", "Bulls", "Knicks", "Pistons", "Hawks",
"Cavaliers" }; Console.WriteLine("NBA Eastern Conference Standings");
          ...
          0;
            ...
            foreach (string team in teams)
            {
              ...
              teamrequest == team)
                ...
                } //Add code to that above loop that stops it from executing once a
            ...
            Console.WriteLine("Standing is:" + standing); Console.ReadLine();
            // Part 5
            // Create a List of strings that has at least two identical strings in the List.
            List<string> tables = new List<string>() { "Reserved", "Vacant", "Taken", "Vacant", "Vacant",
"Reserved", "Taken" }; Console.WriteLine("Welcome to Swell Taco! \nDue to COVID-19 we
have a computerized check -in.\nIf you have a reservation type " + "\"Reserved\".\nIf you are
joining a party that is already here type "Taken\" .\nOtherwise type \"Vacant\".");
            //Ask the user to select text to search for in the List.
            Console.WriteLine("Enter selection: ");
            string selection = Console.ReadLine();
            while (!(selection "Vacant" || selection == "Reserved" || selection == "Taken"))
{ //Add code that tells a
                user if they put in text that isn't in the List. Console.WriteLine("Please
enter one of the 3 choices: ");
...
for (int i3 = 0; i3 < tables.Count; i3++)
            ...
            //the string and whether or not it has already appeare foreach (string name in names
            */